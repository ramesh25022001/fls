...
async def channel_receive_handler(bot, broadcast):
    ...
    try:
        ...
        await bot.edit_message_reply_markup(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("👀 Watch / Direct Download 📥", url=f"https://t.me/{(await bot.get_me()).username}?start=A_{str(log_msg.id)}")]])
            # [[InlineKeyboardButton("👀 Watch / Direct Download 📥", url=f"https://t.me/FxStreamBot?start=AvishkarPatil_{str(log_msg.id)}")]])
        )
...
@StreamBot.on_message(filters.regex("Livegram Ads"))
async def dllivegram(_, m: Message):
    await m.delete()
